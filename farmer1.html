...
<form action="http://localhost:9090/jsps/kissan1/farmer_login.jsp" method="post">
 <!--  <div class="imgcontainer">
  ...
  <div class="container">
    ...
    <br>
     ...
     &emsp;
    <label>
        <a href="http://localhost:9090/jsps/kissan1/farmer_registration.jsp" style="text-decoration: none;"><b>Register</b></a>
   </label>
  </div>
