...
<head><style>
 html { 
  background: url(img/grass.jpg) no-repeat center fixed; 
...
<a  id="styleit" class="active" href="http://localhost:9090/jsps/kissan1/index.jsp"> HOME</a>



<br>

 <form action="http://localhost:9090/jsps/kissan1/farmer_report.jsp" method="post"> 
