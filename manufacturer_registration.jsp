...
<body>
<h2 align="center" style="">Manufacturer Registration</h2>
<div class="container">
  <form action="http://localhost:9090/jsps/kissan1/manufacturer_registration.jsp" method="post"  onsubmit="return confirmpass()">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <textarea id="subject" name="address" maxlength="400" placeholder="Write something.." style="height:200px"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="phno" name="phno" pattern="[7890][0-11]{12}" placeholder="phone number.." required>
      </div>
    </div>
     <div class="row">
      <div class="col-25">
        <label for="Land">Corporate Identity Number</label>
      </div>
      <div class="col-75">
        <input type="text" id="company" name="company"maxlength="21" placeholder="corporate identity no.." required>
      </div>
    </div>
   <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="uname" name="uname" maxlength="15" placeholder="Your User name.." required>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="password" id="pwd" maxlength="20" name="pwd" maxlength="20" placeholder="Your password.." required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
 ...
 <%
        ...
        String sql="insert into MANUFACTURER_REGISTRATION(FIRSTNAME,CROPS,ADDRESS,PHNO,COMPANY,UNAME,PWD,CPWD) values(?,?,?,?,?,?,?,?)";           


	PreparedStatement pstmt=conn.prepareStatement(sql);

            		pstmt.setString(1,firstname);
            		pstmt.setString(2,crops);
...
<hr size=5 color=red>
<a href="http://localhost:9090/jsps/kissan1/manufacturer.jsp">Go back</a>
</body>
</html>